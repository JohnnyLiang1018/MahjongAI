...
def main():   
    test_hands =[  
                    ...
                    [10,10, 10, 11, 11, 11, 12, 12, 12, 13, 13, 13, 31, 33]
                ]

    agent = ma.MahjongAgent(gameboard)
    ai = mai.Mahjong_AI()
    for i in test_hands:
        ...
        print(ai.yaku_check(agent.partition_dict(i,'seq'),agent.partition_dict(i, 'tri'), agent.partition_dict(i, 'pair'),''))
        print("="*20)
