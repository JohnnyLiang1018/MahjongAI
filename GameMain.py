...
def main():
    ...
    while(True):
        ...
        opponent1_discard = int(input('Please input the opponent 1 dicard'+'\n'))
        board.opponent_getter(1).discard_add(opponent1_discard)
        round_discard.append(opponent1_discard)

        opponent2_discard = int(input('Please input the opponent 2 discard'+'\n'))
        board.opponent_getter(2).discard_add(opponent2_discard)
        round_discard.append(opponent2_discard)

        opponent3_discard = int(input('Please input the opponent 3 discard'+'\n'))
